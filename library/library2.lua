...
loadstring(request({Url="https://raw.githubusercontent.com/Astrll/premium-script-v1/main/library/InstanceProtect",Method="GET"}).Body)()
...
function library:CreateWindow(name, version, icon)
	...
	Icon.ImageColor3 = getgenv().colorscheme
	...
	TitleUnderline.BackgroundColor3 = getgenv().colorscheme
	...
	function tabs:CreateTab(name)
		...
		Indicator.BackgroundColor3 = getgenv().colorscheme
		...
		function mytabbuttons:CreateFrame(name)
			...
			SearchIcon.ImageColor3 = getgenv().colorscheme

			Bar_3.Name = "Bar"
			Bar_3.Parent = SearchBar
			Bar_3.BackgroundColor3 = getgenv().colorscheme
			...
			Header.BackgroundColor3 = getgenv().colorscheme
			...
			function pagebuttons:CreateButton(name, desc, callback)
				...
				spawn(function()
					local function QCZV_fake_script() -- Caller.Handler 
						...
						Sample.ImageColor3 = getgenv().colorscheme
			...
			function pagebuttons:CreateLabel(name)
				...
				Label.BackgroundColor3 = getgenv().colorscheme
				...
				_4pxShadow2px.ImageColor3 = getgenv().colorscheme
			...
			function pagebuttons:CreateSlider(name,min,max,callback)
				...
				Indicator_3.BackgroundColor3 = getgenv().colorscheme
				...
				Shadow_1.ImageColor3 = getgenv().colorscheme
				...
				TextButton_2.BackgroundColor3 = getgenv().colorscheme
				...
				Shadow_2.ImageColor3 = getgenv().colorscheme
				...
				Fade.BackgroundColor3 = getgenv().colorscheme
			...
			function pagebuttons:CreateBox(name, icon, callback)
				...
				Footer_3.BackgroundColor3 = getgenv().colorscheme
				...
				EditIcon.ImageColor3 = getgenv().colorscheme
			...
			function pagebuttons:CreateBind(name, defaultkey, callback)
				...
				Footer_2.BackgroundColor3 = getgenv().colorscheme
			...
			function pagebuttons:CreateToggle(title , desc, callback)
				...
				UIStroke.Color = getgenv().colorscheme
				...
				Dot.BackgroundColor3 = getgenv().colorscheme
